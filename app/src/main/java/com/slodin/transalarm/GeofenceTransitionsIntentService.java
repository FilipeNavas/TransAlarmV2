...
public class GeofenceTransitionsIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (geofenceTransition == Geofence.GEOFENCE_TRANSITION_ENTER) {
            ...
            //run the array of geofences, if one of them is the DESTINATION, then the app triggers the alarm
            //If not, the app update the UI only
            for (Geofence geofence : triggeringGeofences) {

                //if the geofence id is DESTINATION, it means that the user needs to alerted
    ...
    private void sendNotificationCurrentLocation(String notificationDetails) {
        ...
        builder.setSmallIcon(R.drawable.ic_stat_name)
                ...
                .setContentTitle("You are at: " + notificationDetails)
                .setContentText(getString(R.string.geofence_transition_notification_text))
                .setContentIntent(notificationPendingIntent);
